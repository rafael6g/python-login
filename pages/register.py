...
def render_layout(message):
    ...
    layout = dbc.Card([
        html.Img(id="logo", src=app.get_asset_url("logo_real94.png"), style={"margin-bottom":"5px","justify-content": "center"}),
        html.H2("TRANSPORTE | LOGISTICA | ARMAZENAGEM", style={"font-size": "11px", "text-align": "center"}),
